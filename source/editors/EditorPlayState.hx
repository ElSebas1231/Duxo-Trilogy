...
class EditorPlayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreTxt = new FlxText(10, FlxG.height - 50, FlxG.width - 20, "Aciertos: 0 | Fallos: 0", 20);
		...
		sectionTxt = new FlxText(10, 580, FlxG.width - 20, "Sección: 0", 20);
		...
		var tipText:FlxText = new FlxText(10, FlxG.height - 24, 0, 'Presiona ESC para volver al Chart Editor', 16);
	...
	override function update(elapsed:Float) {
		...
		keyShit();
		scoreTxt.text = 'Aciertos: ' + songHits + ' | Fallos: ' + songMisses;
		sectionTxt.text = 'Sección actual: ' + curSection;
		beatTxt.text = 'Beat actual: ' + curBeat;
		stepTxt.text = 'Step actual: ' + curStep;
