...
class ClientPrefs {
	...
	public static var framerate:Int = 70;
	...
	public static var timeBarType:String = 'Tiempo Restante';
	public static var scoreZoom:Bool = true;
	public static var noReset:Bool = false;
	public static var noPause:Bool = true;
	public static var healthBarAlpha:Float = 1;
	public static var controllerMode:Bool = false;
	public static var hitsoundVolume:Float = 0;
	public static var pauseMusic:String = 'Tea Time';
	public static var titleVer:String = 'Default';
	public static var loadingScreen:String = 'Default';
	...
	public static function saveSettings() {
		...
		FlxG.save.data.noPause = noPause;
		...
		FlxG.save.data.titleVer = titleVer;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.noPause != null) {
			noPause = FlxG.save.data.noPause;
		}
		...
		if(FlxG.save.data.titleVer != null) {
			titleVer = FlxG.save.data.titleVer;
		}
